...
import cupTradicional from "@/assets/cup-tradicional.jpg";
import cupNutella from "@/assets/cup-nutella.jpg";
import cupTropical from "@/assets/cup-tropical.jpg";
...
const combos = [
  {
    id: "classico",
    name: "Clássico Roxo",
    description: "Açaí cremoso com chantilly e morango fresco — o eterno favorito.",
    volume: 500,
    price: 22.9,
  ...
  },
  {
    id: "nutellatto",
    name: "Nutellatto",
    description: "Calda de Nutella, banana caramelizada e crocante de chocolate.",
    volume: 700,
    price: 29.9,
    image: cupNutella,
    badge: "Novo",
  ...
  },
  {
    ...
    description: "Paçoca, amendoim, leite condensado e banana. Memória afetiva.",
    volume: 500,
    price: 24.9,
    image: cupPacoca,
  },
